<?php 
    ...
    if($sql){
        echo '<script>alert("Berhasil mengubah data siswa."); document.location="data_siswa.php";</script>';
         ...
         '<script>alert("Gagal mengubah data siswa."); document.location="data_siswa.php";</script>';
        }
    }
 ?>
        ...
        ?>
             ...
             <form action="" method="POST">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10"><input type="text" name="nis_siswa" id="nis" class="form-control" value="<?php echo $data['nis_siswa']; ?>"></div>
                </div>
                <div class="form-group row">
                    <label for="nama_siswa" class="col-sm-2 col-form-label">Nama</label>
                    <div class="col-sm-10"><input type="text" name="nama_siswa" id="nama_siswa" class="form-control" value="<?php echo $data['nama_siswa']; ?>"></div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col">
                        <input type="text" readonly="" name="nama_jurusan" class="form-control" value="<?php echo $data['nama_jurusan']; ?>">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-10"><input type="text" name="tahun_ajaran" id="tahun_ajaran" class="form-control" value="<?php echo $data['tahun_ajaran'] ?>"></div>
                      ...
                      <input type="hidden" name="spp_bulan" value="<?php echo $data['spp_bulan']; ?>">
                      <input type="hidden" name="total_tagihan" value="<?php echo $data['total_tagihan']; ?>">
                <div>
